...
<div class="notice notice-warning inline">
	...
	<p>
		<?php esc_html_e( 'By enabling the Troubleshooting Mode, all plugins will appear deactivated and your site will switch to the default theme only for you, but all other users will see your site as usual.', 'health-check' ); ?>
	</p>
